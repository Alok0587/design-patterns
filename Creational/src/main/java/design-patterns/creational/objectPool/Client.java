...
public class Client {
    public static void main(String[] args){
        com.creational.objectPool.DBConnectionPool dbConnectionPool=new com.creational.objectPool.DBConnectionPool(5);
        try {
            for(int i=0; i<10; i++){
                com.creational.objectPool.DBConnection dbConnection=dbConnectionPool.getConnection();
